...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $advancedJobModel = new AdvancedJobForm();


        return $this->render('index', [
            'model' => $model,
            'advancedJobModel' => $advancedJobModel,
        ]);
    }
    ...
    public function actionLogin()
    {
        ...
        if ($modelPasswordReset->load(Yii::$app->request->post()) && $modelPasswordReset->validate())
        {
            if ($modelPasswordReset->sendEmail())
            {
                Yii::$app->session->setFlash('success', 'Check your email');
            }else{
                Yii::$app->session->setFlash('error', 'Sorry, we can\'t send password' );
            }
        }
