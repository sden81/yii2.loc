...
<div class="body-content clearfix">
    <div class="block-section bg-color4">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php foreach ($authAuthChoice->getClients() as $client){
                                $info = $authRenderer[$client->getName()];
                                ?>
                                <p>
                                    <?php echo $authAuthChoice->clientLink($client, '<i class="fa '.$info['icon'].' pull-left border-right"></i> '.$info['text'],[]) ?>
                                </p>
                            <?php } ?>
                            <?php AuthChoice::end(); ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 text-right">
                                        <p class="help-block"><a href="#myModal" data-toggle="modal">Forgot
                                                password?</a></p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="text-center color-white">Not a member? &nbsp; <a
                    href="<?= \yii\helpers\Url::toRoute(['site/signup']) ?>" class="link-white"><strong>Create an
                        account free</strong></a></div>
        </div>
    </div>
